                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        <div>
                                    ...
                                    <div className='grid grid-cols-3 gap-2 border rounded-lg p-5'>
                                        {timeSlot?.map((item, index) => (
                                            <h2
                                                ...
                                                className={`p-2 border cursor-pointer text-center hover:bg-primary hover:text-white rounded-full ${item.time === selectedTimeSlot && 'bg-primary text-white'}`}
                                            >
                                                {item.time}
                                            </h2>
                                        ))}
                            ...
                            <Textarea className="mt-3" placeholder="Nota / Comentarios" onChange={(e) => setNote(e.target.value)} />
                        </div>
                    </DialogDescription>
                </DialogHeader>
